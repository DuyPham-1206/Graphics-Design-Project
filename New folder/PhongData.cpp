...
void MySetupLights()
{
    ...
    // First light (light #0).
    myLights[0].AmbientColor.Set(0.7, 0.7, 0.7);    // Gray color
    myLights[0].DiffuseColor.Set(0.55,0.55,0.55);      // Very light gray
    ...
    myLights[1].AmbientColor.Set(0.2, 0.2, 0.06);    // Yellow color
    myLights[1].DiffuseColor.Set(0.35, 0.35, 0.1);    // Yellow
    myLights[1].SpecularColor.Set(0.7, 0.7, 0.0);   // White
    myLights[1].IsEnabled = true;                     // BE SURE TO ENABLE YOUR LIGHTS

    // Third light (light #2)
    myLights[2].AmbientColor.Set(0.0, 0.3, 0.3);    // cyan
    myLights[2].DiffuseColor.Set(0.12, 0.3, 0.3);      // Very light gray
...
void MySetupMaterials()
{
    ...
    //myMaterials[0].EmissiveColor.Set(0,0,0);   // THIS SHOULD CHANGE TO 0,0,0 SO IT HAS NO EMISSION
