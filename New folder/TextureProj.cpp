...
void key_callback(GLFWwindow* window, int key, int scancode, int action, int mods) {
    ...
    case GLFW_KEY_UP:
        viewAzimuth = Min(viewAzimuth + 0.05, PIhalves - 0.05);
        viewChanged = true;
        break;
    case GLFW_KEY_DOWN:
        viewAzimuth = Max(viewAzimuth - 0.05, -PIhalves + 0.05);
        viewChanged = true;
        break;
    case GLFW_KEY_RIGHT:
        viewDirection += 0.05;
...
int main() {
    ...
    printf("Press '5' key to change to a random channel on the projector.\n");
    printf("Press '6' key to turn off projector.\n");
